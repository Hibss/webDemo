...
public class BeanUtils
{
    ...
    public static boolean isEEmpty(Object o)
    {
        if (o == null){
     ...
     * 
     * @param o java.lang.Object.
     * @param isContent java.lang.boolean. 默认false，标示是否判断内容为空。
     * @return boolean.
     */
    @SuppressWarnings("unused")
    public static boolean isEmptyArray(Object o, boolean isContent)
    {
        if (o == null){
    ...
    public static boolean isNotEEmpty(Object o)
    {
        return !isEEmpty(o);
    }
